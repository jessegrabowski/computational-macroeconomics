...
M_.param_names_long(6) = {'AR(1) coefficient in technology'};
M_.param_names(7) = {'sigma_A'};
M_.param_names_tex(7) = {'{sigma_A}'};
M_.param_names_long(7) = {'Standard deviation of technology shocks'};
...
steady;
save('basic_rbc_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('basic_rbc_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('basic_rbc_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('basic_rbc_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('basic_rbc_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('basic_rbc_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('basic_rbc_results.mat', 'oo_recursive_', '-append');
end
